...
namespace interface01
{
	partial class DELcarro
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Digite o ID do Carro a ser DELETADO.";
			// 
			// button3
			// 
			...
			this.button1.Location = new System.Drawing.Point(305, 56);
			...
			this.Text = "Deletar CARRO (LOCADORA PRO v1.0)";
